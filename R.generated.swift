...
struct R: Rswift.Validatable {
  ...
  struct reuseIdentifier {
    ...
    static let cell: Rswift.ReuseIdentifier<MainCell> = Rswift.ReuseIdentifier(identifier: "cell")
    ...
    struct localizable {
      ...
      static func mainVCTitle(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("MainVCTitle", bundle: hostingBundle, comment: "")
        }
